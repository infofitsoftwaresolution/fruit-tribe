    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-100 pt-28 pb-12 px-4">
      ...
      >
        <div className="flex flex-col items-center mb-6">
          ...
          <h1 className="text-xl font-bold text-slate-900 tracking-tight">Verify your email</h1>
          <p className="text-sm text-slate-500 mt-1 text-center">
            We&apos;ve sent a 6-digit verification code to your email. Enter it below to complete registration.
          </p>
        </div>
